...
public class AdapterFeedbackList extends BaseExpandableListAdapter{
	...
	public AdapterFeedbackList(Context context, ArrayList<FeedbackRowGroup> ratings) {
	...
	@Override
	 ...
	 public View getChildView(int groupPosition, int childPosition, boolean isLastChild, 
	  ...
	  RatingBar ratingBarRowContenuti = (RatingBar)view.findViewById(R.id.ratingBarRowContenuti);
	  ratingBarRowContenuti.setRating(inf.getRating_contenuti());
	  
	  RatingBar ratingBarRowCfu = (RatingBar)view.findViewById(R.id.ratingBarRowCfu);
	  ratingBarRowCfu.setRating(inf.getRating_cfu());
	  
	  RatingBar ratingBarRowLezioni = (RatingBar)view.findViewById(R.id.ratingBarRowLezioni);
	  ratingBarRowLezioni.setRating(inf.getRating_lezioni());
	  
	  RatingBar ratingBarRowMateriali = (RatingBar)view.findViewById(R.id.ratingBarRowMateriali);
	  ratingBarRowMateriali.setRating(inf.getRating_cfu());
	  
	  RatingBar ratingBarRowEsame = (RatingBar)view.findViewById(R.id.ratingBarRowEsame);
	 ...
	 public View getGroupView(int groupPosition, boolean isLastChild, View view,
	  ...
	  TextView heading = (TextView) view.findViewById(R.id.textViewAuthorRating);
